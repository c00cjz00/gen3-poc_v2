<?php
// ??????token
#$url_token = "https://gen7.biobank.org.tw/user/credentials/cdis/access_token";
...
$url_post = "https://gen7.biobank.org.tw/api/v0/submission/jnkns/jenkins/";
$json='[
    {
...
function post_data($url,$json,$token){
        $cmd="curl 'https://gen7.biobank.org.tw/api/v0/submission/jnkns/jenkins/' \
-X 'PUT' \
...
-H 'Origin: https://gen7.biobank.org.tw' \
-H 'Sec-Fetch-Site: same-origin' \
-H 'Sec-Fetch-Mode: cors' \
-H 'Sec-Fetch-Dest: empty' \
-H 'Referer: https://gen7.biobank.org.tw/jnkns-jenkins' \
